      ...
      <div id="carouselExampleCaptions" class="carousel slide bg-dark" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="../../public/img/hero_img1_s.png" class="d-block w-100" alt="Main Menu" />
          ...
          <div class="carousel-item">
            <img src="../../public/img/hero_img2_s.png" class="d-block w-100" alt="Main Menu" />
            <div class="carousel-caption d-none d-md-block">
          ...
          <div class="carousel-item">
            <img src="../../public/img/hero_img3_s.png" class="d-block w-100" alt="Main Menu" />
            <div class="carousel-caption d-none d-md-block">
            ...
            <div class="row flex-column flex-md-row">
              <div class="col d-flex flex-column justify-content-center">
                ...
                <p class="lead">
                  ...
                  <a class="text-light" href="./project.html#founders">this community</a> and built
                  using FLOSS.
                </p>
              </div>
          ...
          <div class="container text-center">
            <div>
              ...
              <p class="lead" style="font-size: 2.5rem">
                Core version 2 - Alpha launcher
                <a href="https://github.com/mapod4d/mapod4d_launcher_c2" target="_blank">here</a>
              </p>
            </div>
          </div>
        </article>
